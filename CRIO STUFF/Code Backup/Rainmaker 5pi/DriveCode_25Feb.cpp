...
static const int armShootRight = 345;     //read only. value of arm potentiometer when shooting to the left
static const int armShootLeft = 590;    //ditto except to the right
