...
bool startAuto = true;;                  //tells the computer whether or not it is just beginning the autonomous phase. see void AutonomousPeriodic()
...
public:
	...
	DriveControl(void)
	{
		...
		//sole[1] = new DoubleSolenoid(2, 1, 2); //launcher solenoid. parameters - 9472 module #; port; port (two ports needed for double actions)
		//sole[2] = new DoubleSolenoid(2, 7, 8); //shifter solenoid
		
		hGear = new Solenoid(2, 3);
		lGear = new Solenoid(2, 4);
		launch = new Solenoid(2, 1);
		retract = new Solenoid(2, 2);
		
		//sole[n]->Set(DoubleSolenoid::kForward);
		//sole[n]->Set(DoubleSolenoid::kReverse);
