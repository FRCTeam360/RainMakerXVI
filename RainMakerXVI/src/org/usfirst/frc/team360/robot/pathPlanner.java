 ...
 */
	...
	public static void main(String[] args)
	{
		...
		if(!GraphicsEnvironment.isHeadless())
		{
			...
			pathGraph fig2 = new pathGraph(path.smoothCenterVelocity,null,Color.blue);
			fig2.yGridOn();
			fig2.xGridOn();
			...
			pathGraph fig1 = new pathGraph(path.nodeOnlyPath,Color.blue,Color.green); 
			fig1.yGridOn();
			fig1.xGridOn();
			...
			double[][] goalLine = new double[][] {{26.5,2}, {26.5, 2}};
			fig1.addData(goalLine, Color.black);
			...
			fig1.addData(path.rightPath, Color.CYAN);
...
*/
		...
		for(int i=0; i<path.rightPath.length; i++){
			
			finalSpeed = pidVelocity(path.leftPath[i][1]);
			
			System.out.println(path.leftPath[i][0] + "l");
			System.out.println(path.rightPath[i][0] + "r");
	...
	public void poofExample()
	{
		...
		pathGraph fig3 = new pathGraph(new double[][]{{0.0,0.0}});
		fig3.yGridOn();
		fig3.xGridOn();
		...
		//Velocity
		pathGraph fig4 = new pathGraph(path.smoothCenterVelocity,null,Color.blue);
		fig4.yGridOn();
		fig4.xGridOn();
		...
		//PathPlanner.print(path.heading);


	}
	
	public static double pidVelocity(double velocity){
