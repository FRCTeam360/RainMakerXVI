...
public class Const {
	 ...
	 //each level is up 12.5 inches from previous, and 1 rotation of drum = 360 tick. diameter is 2 3/8"
	...
	public static float liftLevel1 = 532; 
	...
	//public static float liftLevelground = 50;
