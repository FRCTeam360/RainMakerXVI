 ...
 *
 */
public class enablePID1 extends Command {
    ...
    protected void execute() {
    	controls.myRobot.tankDrive(output, output);
    }
    ...
    public void liftControl1() {
    	...
    	double PIDOUTPUT1 = doPID1(p, i, d, Dt, controls.EnvGlbValR, 100);// ONLY CHANGE THE LAST NUMBER DO NOT TOUCH ANYTHING ELSE HERE
