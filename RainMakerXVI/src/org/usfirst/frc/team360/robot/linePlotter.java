...
class pathGraph extends JPanel implements ClipboardOwner{
  
	private final int yPAD = 60; //controls how far the X- and Y- axis lines are away from the window edge
    private final int xPAD = 60; //controls how far the X- and Y- axis lines are away from the window edge
     ...
     */
    public pathGraph(double[] yData)
    {
    	this(null,yData,Color.red);
    }
    
    public pathGraph(double[] yData,Color lineColor, Color marker)
    {
     ...
     */
    public pathGraph(double[] xData, double[] yData)
    {
 ...
 */
    public pathGraph(double[][] data, Color lineColor, Color markerColor)
    {
     ...
     * @param lineColor is the color the user wishes to be displayed for the line connecting each datapoint
     */
    public pathGraph(double[] xData, double[] yData,Color lineColor)
    {
     ...
     * not have datapoint markers.
     */
    public pathGraph(double[] xData, double[] yData,Color lineColor, Color markerColor)
    {
    	xLabel = "X axis";
    	yLabel = "Y axis";
    	titleLabel = "Title";
    ...
    private void menu(JFrame g, final pathGraph p )
    {
    ...
    public static void main(String[] args) {
  	...
  	pathGraph fig2 = new pathGraph(data,Color.red, Color.blue);
  	...
  	pathGraph fig1 =  new pathGraph(test,data);
